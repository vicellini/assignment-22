...
let dataSet = [
	...
	{item: `15" Saddle trail ride special `, imgLink: 'https://www.outfitterssupply.com/images/CY1661_irontunnel.jpg', price: 400, description: `Was my ex wife's. She loved to ride horses. I need this gone. Pure craftman leather construction, built to last for ages.`},
	{item: `Fender Banjo`, imgLink: 'http://media.musiciansfriend.com/is/image/MMGS7/FB-54-5-String-Banjo/510462000000000-00-500x500.jpg', price: 180, description: `Was in a band but now I'm not. Looking to sell or trade, lemme know if you have a drum set or something that's what i really want.`}
]
